...
def DATASET():
    ...
    dataset = molscore.data.Dataset(['C', 'O=C=O'])
    return dataset
...
class TestDataHandler:
    ...
    def test_register_dataset(self, mocked_metadata_saver, working_test_dir,
                              DATASET):
        import molscore.data
        handler = molscore.data.DataHandler(root=working_test_dir + '/root',
                                            restart=True)
    ...
    @mock.patch('molscore.data.DataHandler._save_metadata')
    def test_update_dataset(self, mocked_metadata_saver, working_test_dir,
                            DATASET):
        import molscore.data
        handler = molscore.data.DataHandler(root=working_test_dir + '/root',
                                            restart=True)
    ...
    @mock.patch('molscore.data.DataHandler._save_metadata')
    def test_unregister_dataset(self, mocked_metadata_saver, working_test_dir,
                                DATASET):
        import molscore.data
        handler = molscore.data.DataHandler(root=working_test_dir + '/root',
                                            restart=True)
...
class TestDataset:
    def test___init__(self, working_test_dir):
        ...
        dataset = molscore.data.Dataset(['C', 'CC'],
